...
const HomeProjects = ({ projectData }) => {
    const { name, img, des, preview, serverCode, clientCode, _id } = projectData;
    console.log(name)
    const [cliked, setCliked] = useState(false)
    return (
        <div className="mx-auto transform hover:scale-105 transition duration-700 ease-out">
